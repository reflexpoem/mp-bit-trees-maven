...
public class BATableExperiments {
  ...
  public static void main(String[] args) {
    ...
    for (char letter = 'A'; letter <= 'Z'; ++letter) {
      try {
        pen.println(letter + " -> " + BrailleAsciiTables.convertToBraille(letter));
      } catch (Exception e) {
    ...
    for (String bits : brailleCharacters) {
      try {
        pen.println(bits + " -> '" + BrailleAsciiTables.convertToAscii(bits) + "'");
      } catch (Exception e) {
    ...
    for (String bits : brailleCharacters) {
      try {
        pen.println(bits + " -> '" + BrailleAsciiTables.convertToUnicode(bits) + "'");
      } catch (Exception e) {
